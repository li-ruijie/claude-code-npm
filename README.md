...
Builds are automated via GitHub Actions. A daily check detects new releases of Claude Code, Node.js LTS, or Deno and triggers a fresh build cycle.
...
Two runtimes × two platforms × two architectures = 12 artifacts per release cycle.
